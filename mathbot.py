...
def math_bot():
    while True:
        ...
        if user_input_1 == "addition" or user_input_1 == "add":
            ...
            result = operand1 - operand2
            print("BOT:The difference between", operand1,
                  "and", operand2, "is", result)
        elif user_input_1 == "multiplication" or user_input_1 == "multiply":
            result = operand1 * operand2
            print("BOT:The product of", operand1,
                  "and", operand2, "is", result)
            ...
            if operand2 == 0:
                ...
                result = operand1 / operand2
                print("BOT:The quotient of", operand1,
                      "and", operand2, "is", result)
            ...
            print("BOT:The square root of", operand1,
                  "to the", operand2, "is", result)
        else:
